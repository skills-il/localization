...
1. כל פסקה עברית נושאת `<w:bidi/>` (כיוון בסיס RTL). זה מה ששומר על סדר השורה מימין לשמאל ומאפשר ל-Word למקם נכון אנגלית ומספרים מוטבעים. העוזר קובע זאת לכל פסקה לפי האם השורה מכילה עברית: שורה באנגלית בלבד (ערך מעבדה, שם תרופה, שורה באנגלית בלבד) מקבלת בסיס LTR ויישור לשמאל, כך שהיא לא מרונדרת מיושרת לימין במסמך עברי.
