...
|----------|-------------|-----------------|
| חשבונית מס | חשבונית מס | שם עסק, מספר עוסק מורשה, תאריך, פריטים, מע"מ (17%), סה"כ |
...
- סכום ביניים, מע"מ 17%, וסה"כ בש"ח

## דוגמאות

### דוגמה 1: יצירת חשבונית מס PDF
המשתמש אומר: "צור חשבונית מס בעברית כ-PDF לעסק שלי"
תוצאה: שימוש ב-reportlab או WeasyPrint ליצירת PDF בגודל A4 עם פריסת RTL, כותרת עסק, מספר חשבונית רץ, טבלת פריטים, חישוב מע"מ 17%, סכומים בש"ח עם סמל שקל, וגופן עברי לאורך כל המסמך.
