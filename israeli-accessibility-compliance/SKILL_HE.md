...
|------|--------|-------|---------|
| ת"י 5568 (בתוקף מ-2017, עודכן 2020 ו-2023) | תקן נגישות ישראלי, מעוגן ב-WCAG 2.0 AA | אתרים חדשים נגישים מ-25 באוקטובר 2015; אתרים קיימים עד 26 באוקטובר 2017; מועד אוקטובר 2020 הרחיב את מדרגות הפטור בעלות מחזור נמוך, לא את המועד הכללי | פיצוי סטטוטורי ללא הוכחת נזק, בסיס 50,000 ש"ח לפי סעיף 19נא(ב), צמוד למדד (ראו שלב 3) |
...
| מחזור שנתי ממוצע מתחת ל-120,000 ש"ח | פטור זמני ל-3 שנים, ניתן לחידוש כל 3 שנים כל עוד המחזור הממוצע נשאר עד 120,000 ש"ח |
| מחזור שנתי ממוצע מ-120,000 ש"ח ועד 1,000,000 ש"ח | פטור ל-3 שנים לאתר קיים שהפעלתו החלה לפני 26 באוקטובר 2017; אתר חדש שנבנה אחרי מועד זה חייב בהנגשה |
...
הפטורים האלה (חוץ מבקשת הנטל הכבד) אוטומטיים ואינם דורשים אישור, אבל המפעיל חייב לבדוק מחדש את המחזור כל 3 שנים. פטור מהנגשת אתר אינו פוטר מחובות נגישות אחרות בשירות, ואינו פוטר מחובת **נגישות המבנה** (נגישות פיזית) שמוסדרת בתקנות נפרדות.
...
סעיף 26ז(ב) קובע בנפרד **27,360 ש"ח** להפרת חובת הייצוג ההולם. תוספת לכל יום נצברת כל עוד ההפרה נמשכת, והפחתות חלות בעבור עבר נקי ובעבור פעולה מתקנת.

**שני המסלולים אינם מצטברים במלואם.** תיקון 23 הוסיף הגנות בסעיף 19נא(ג)(1א)-(1ב): בית המשפט **לא** יפסוק פיצוי ללא הוכחת נזק כאשר המפעיל כבר הגיש **כתב התחייבות** לפי פרק ט' סימן ג' והוא מקיים אותו, או כאשר כבר הוטל עליו עיצום כספי או ניתנה לו התראה מינהלית בשל אותו מעשה או מחדל, והגנה זו עומדת לו לפרק הזמן שקבע הנציב לביצוע התאמות הנגישות. סעיף 19נג(ג) אוסר במקביל על הנציבות לתבוע בשל מעשה שכבר הוטל בגינו עיצום כספי. למפעיל שהלך במסלול המנהלי יש אפוא מענה אמיתי לתביעה אזרחית מאוחרת על אותן עובדות.

**תקופת תיקון של 60 יום.** סטייה אינה נחשבת הפרה אלא אם נשלחה למפעיל הודעה הדורשת תיקון והוא לא תיקן בתוך זמן סביר, ולא יאוחר מ-60 יום מקבלת ההודעה. לבקשה לאישור תביעה ייצוגית בגין אתר לא נגיש אין עילת תביעה אם לא נשלחה קודם הודעת תיקון. זו הגנה ממשית למפעילים.
...
שתי חובות נוספות מיוחסות לרכז בדרך כלל, אבל מקורן בתקנות נגישות לשירות ולא בסעיף 19מב, ולכן אין לצטט את החוק עבורן:
...
- סוכנים עלולים להעתיק כלל ישן ולפיו "עסקים עם 25+ עובדים או מחזור 300,000 ש"ח חייבים בהנגשה". המספר הזה אינו בתקנות. חובת הנגשת האתר אוניברסלית לשירותים הפתוחים לציבור, בכפוף לפטורים לפי מחזור (ראו שלב 2, מי פטור). סף 25 העובדים הוא הטריגר למינוי רכז נגישות לפי סעיף 19מב לחוק, חובה נפרדת בדבר חקיקה אחר.
...
- סוכנים עלולים להניח ששני מסלולי האכיפה מצטברים במלואם. סעיפים 19נא(ג)(1א)-(1ב) ו-19נג(ג) מעניקים למפעיל שהגיש כתב התחייבות, או שכבר הוטל עליו עיצום כספי בשל אותו מעשה, הגנה מפני פיצוי ללא הוכחת נזק (ראו שלב 3).
