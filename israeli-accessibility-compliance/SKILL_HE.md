...
|------|--------|-------|---------|
| ת"י 5568 (בתוקף מ-2017, עודכן 2020 ו-2023) | תקן נגישות ישראלי. המהדורה הנוכחית ת"י 5568:2020 תואמת ל-WCAG 2.1 AA | חובה מאוקטובר 2017; דדליין עד אוקטובר 2020 לעסקים שהיו קיימים לפני 2017 | עד 50,000 ש"ח פיצוי ללא הוכחת נזק לכל הפרה |
...
| אתרים ממשלתיים | חייבים לעמוד ב-IS 5568 רמה AA | בתוקף | פיקוח של הנציבות + צעדים מנהליים |

**הערה על גרסת WCAG.** החוק והתקנות מפנים אל ת"י 5568. המהדורה הנוכחית היא **ת"י 5568:2020**, שמתואמת ל-WCAG 2.1 AA, ו-ת"י 5568 חלק 1 קיבל עדכון טכני נוסף בספטמבר 2023. מקורות ישנים לפעמים עדיין כותבים "WCAG 2.0 AA" כי זו הייתה ההתאמה כשהתקנות נכנסו לתוקף לראשונה. כיוון העבודה: עמידה בת"י 5568:2020 (WCAG 2.1 AA). WCAG 2.2 עדיין לא נדרש בחקיקה הישראלית, אבל העמידה בקריטריונים הנוספים שלו היא תרגיל מועיל להתכוננות לעתיד.

**מי חייב לעמוד בדרישות:** כל האתרים והאפליקציות הציבוריות בישראל, כולל עסקים עם 25+ עובדים (או מחזור שנתי מעל 300,000 ש"ח), גופים ממשלתיים, מוסדות חינוך, ספקי בריאות וכל ספק שירות שפתוח לציבור.

### שלב 2: IS 5568 מול WCAG 2.1 - ההבדלים העיקריים

ת"י 5568:2020 מבוסס על WCAG 2.1 AA אבל מוסיף דרישות ייחודיות לישראל:
