...
- יום העצמאות ויום הזיכרון יכולים להידחות (נדחה) כשהתאריך הטבעי מתנגש עם שבת. בשנת 2026 אין דחייה (ה' באייר תשפ"ו חל ב-21 עד 22 באפריל). כדאי לסמוך על דגל `i=on` של Hebcal ולא לחשב ה' באייר ידנית.
